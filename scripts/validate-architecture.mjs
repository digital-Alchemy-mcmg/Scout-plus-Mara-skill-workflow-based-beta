...
check('Candidate Core is first-class', types.includes('interface CandidateCore') && types.includes('CanonicalCandidateSpatialDNA'), 'Canonical runtime type contains Candidate Core.');
